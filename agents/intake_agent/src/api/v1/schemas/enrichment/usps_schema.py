...
class USPSAddressRequestSchema(BaseModel):
    ...
    address_line2: Optional[str] = Field(None, description="Secondary address line (apt, suite, etc)")
...
class USPSAddressResponseSchema(BaseModel):
    ...
    standardized_address: Optional[str] = Field(None, description="Standardized address format")
