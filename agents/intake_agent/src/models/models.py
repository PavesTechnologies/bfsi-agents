...
class AuditLogs(Base):
    ...
    __table_args__ = (PrimaryKeyConstraint("id", name="audit_logs_pkey"),)
...
class LoanApplication(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "credit_type::text = ANY (ARRAY['individual'::character varying, 'joint'::character varying]::text[])",  # noqa: E501
            name="loan_application_credit_type_check",
        ),
        CheckConstraint(
            "preferred_payment_day >= 1 AND preferred_payment_day <= 28",
            name="loan_application_preferred_payment_day_check",
        ),
        CheckConstraint(
            "requested_amount > 0::numeric",
            name="loan_application_requested_amount_check",
        ),
    ...
    loan_purpose: Mapped[str | None] = mapped_column(String(50))
    requested_amount: Mapped[decimal.Decimal | None] = mapped_column(Numeric(12, 2))
    requested_term_months: Mapped[int | None] = mapped_column(Integer)
    preferred_payment_day: Mapped[int | None] = mapped_column(Integer)
    origination_channel: Mapped[str | None] = mapped_column(String(20))
    ...
    applicant: Mapped[list["Applicant"]] = relationship(
        "Applicant", back_populates="application", lazy="selectin"
    )
    ...
    documents = relationship(
        "Document", back_populates="application", overlaps="document"
    )

    pgsql_documents = relationship(
        "PgsqlDocument", back_populates="application", cascade="all, delete-orphan"
    )
...
class Applicant(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "applicant_role::text = ANY (ARRAY['primary'::character varying, 'co_applicant'::character varying]::text[])",  # noqa: E501
            name="applicant_applicant_role_check",
        ),
        ForeignKeyConstraint(
            ["application_id"],
    ...
    applicant_role: Mapped[str | None] = mapped_column(String(20))
    middle_name: Mapped[str | None] = mapped_column(String(100))
    suffix: Mapped[str | None] = mapped_column(String(10))
    email: Mapped[str | None] = mapped_column(Text)
    ssn_encrypted: Mapped[str | None] = mapped_column(Text)
    ssn_last4: Mapped[str | None] = mapped_column(CHAR(4))
    itin_number: Mapped[str | None] = mapped_column(String(15))
    ...
    application: Mapped["LoanApplication"] = relationship(
        "LoanApplication", back_populates="applicant", lazy="selectin"
    )
    address: Mapped[list["Address"]] = relationship(
        "Address", back_populates="applicant", lazy="selectin"
    )
    asset: Mapped[list["Asset"]] = relationship(
        "Asset", back_populates="applicant", lazy="selectin"
    )
    employment: Mapped[list["Employment"]] = relationship(
        "Employment", back_populates="applicant", lazy="selectin"
    )
    income: Mapped[list["Income"]] = relationship(
        "Income", back_populates="applicant", lazy="selectin"
    )
    liability: Mapped[list["Liability"]] = relationship(
        "Liability", back_populates="applicant", lazy="selectin"
    )
...
class Address(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "address_type::text = ANY (ARRAY['current'::character varying, 'permanent'::character varying, 'mailing'::character varying]::text[])",  # noqa: E501
            name="address_address_type_check",
        ),
        CheckConstraint(
            "housing_status::text = ANY (ARRAY['own'::character varying, 'rent'::character varying]::text[])",  # noqa: E501
            name="address_housing_status_check",
        ),
        CheckConstraint(
            "months_at_address >= 0 AND months_at_address <= 11",
            name="address_months_at_address_check",
        ),
        CheckConstraint(
            "years_at_address >= 0 AND years_at_address <= 50",
            name="address_years_at_address_check",
        ),
        ForeignKeyConstraint(
            ["applicant_id"],
    ...
    country: Mapped[str | None] = mapped_column(
        String(50), server_default=text("'USA'::character varying")
    )
    housing_status: Mapped[str | None] = mapped_column(String(30))
    monthly_housing_payment: Mapped[decimal.Decimal | None] = mapped_column(
        Numeric(10, 2)
    )
    years_at_address: Mapped[int | None] = mapped_column(Integer)
    months_at_address: Mapped[int | None] = mapped_column(Integer)
    address_verified: Mapped[bool | None] = mapped_column(
        Boolean, server_default=text("false")
    )

    applicant: Mapped["Applicant"] = relationship(
        "Applicant", back_populates="address", lazy="selectin"
    )
...
class Asset(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "ownership_type::text = ANY (ARRAY['individual'::character varying, 'joint'::character varying]::text[])",  # noqa: E501
            name="asset_ownership_type_check",
        ),
    ...
    ownership_type: Mapped[str | None] = mapped_column(String(20))
    asset_verified: Mapped[bool | None] = mapped_column(
        Boolean, server_default=text("false")
    )

    applicant: Mapped["Applicant"] = relationship(
        "Applicant", back_populates="asset", lazy="selectin"
    )
...
class Employment(Base):
    ...
    employer_phone: Mapped[str | None] = mapped_column(String(20))
    ...
    self_employed_flag: Mapped[bool | None] = mapped_column(
        Boolean, server_default=text("false")
    )
    family_employment: Mapped[bool | None] = mapped_column(
        Boolean, server_default=text("false")
    )
    gross_monthly_income: Mapped[decimal.Decimal | None] = mapped_column(Numeric(12, 2))
    employment_verified: Mapped[bool | None] = mapped_column(
        Boolean, server_default=text("false")
    )

    applicant: Mapped["Applicant"] = relationship(
        "Applicant", back_populates="employment", lazy="selectin"
    )
...
class Income(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "monthly_amount >= 0::numeric", name="income_monthly_amount_check"
        ),
        ForeignKeyConstraint(
            ["applicant_id"],
            ["applicant.applicant_id"],
            ondelete="CASCADE",
            name="fk_income_applicant",
        ),
    ...
    applicant_id: Mapped[uuid.UUID] = mapped_column(Uuid, nullable=False)
    income_type: Mapped[str | None] = mapped_column(String(50))
    description: Mapped[str | None] = mapped_column(Text)
    monthly_amount: Mapped[decimal.Decimal | None] = mapped_column(Numeric(12, 2))
    income_frequency: Mapped[str | None] = mapped_column(String(20))

    applicant: Mapped["Applicant"] = relationship(
        "Applicant", back_populates="income", lazy="selectin"
    )
...
class Liability(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "monthly_payment >= 0::numeric", name="liability_monthly_payment_check"
        ),
        CheckConstraint(
            "months_remaining >= 0", name="liability_months_remaining_check"
        ),
        CheckConstraint(
            "outstanding_balance >= 0::numeric",
            name="liability_outstanding_balance_check",
        ),
        ForeignKeyConstraint(
            ["applicant_id"],
            ["applicant.applicant_id"],
            ondelete="CASCADE",
            name="fk_liability_applicant",
        ),
    ...
    applicant_id: Mapped[uuid.UUID] = mapped_column(Uuid, nullable=False)
    liability_type: Mapped[str | None] = mapped_column(String(50))
    creditor_name: Mapped[str | None] = mapped_column(String(255))
    outstanding_balance: Mapped[decimal.Decimal | None] = mapped_column(Numeric(14, 2))
    monthly_payment: Mapped[decimal.Decimal | None] = mapped_column(Numeric(12, 2))
    months_remaining: Mapped[int | None] = mapped_column(Integer)
    co_signed: Mapped[bool | None] = mapped_column(
        Boolean, server_default=text("false")
    )
    federal_debt: Mapped[bool | None] = mapped_column(
        Boolean, server_default=text("false")
    )
    delinquent_flag: Mapped[bool | None] = mapped_column(
        Boolean, server_default=text("false")
    )
    days_delinquent: Mapped[int | None] = mapped_column(Integer)

    applicant: Mapped["Applicant"] = relationship(
        "Applicant", back_populates="liability", lazy="selectin"
    )
